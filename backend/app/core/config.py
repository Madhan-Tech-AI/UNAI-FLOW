...
class Settings(BaseSettings):
    ...
    # WhatsApp Bulk Messaging API (Render service)
    bulk_api_url: str = "https://unai-whatsapp-bulk-api.onrender.com"
    bulk_api_url_cloud: str = "https://unai-whatsapp-bulk-api.onrender.com"
