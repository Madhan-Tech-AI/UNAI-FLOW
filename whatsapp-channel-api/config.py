...
class Config:
    ...
    CHANNEL_LINK: str = os.getenv("WCA_CHANNEL_LINK", "")
    CHANNEL_ID: str = os.getenv("WCA_CHANNEL_ID", "")
    CHANNEL_NAME: str = os.getenv("WCA_CHANNEL_NAME", os.getenv("WHATSAPP_CHANNEL_NAME", "WhatsApp Channel"))
